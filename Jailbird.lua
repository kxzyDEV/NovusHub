...
local Window = Library:CreateWindow({Title = "Novus Hub", Center = true, AutoShow = true})
...
-- saying i dont want to use quite yet , "I ♥ Novus Hub", "Start winning with Novus Hub!", 

Library:Notify("Loading UI...")
Library:Notify("Newest Version ")
...
local CreditTabbox1 = CredTab:AddLeftTabbox("Credits")
local Cred1 = CreditTabbox1:AddTab("Credit")
Cred1:AddButton("kxzy#0001 - Owner")
